...
class AssembliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assembly" do
    assert_difference("Assembly.count") do
      post assemblies_url, params: { assembly: { serial: @assembly.serial, title: @assembly.title } }
    end
  ...
  test "should update assembly" do
    patch assembly_url(@assembly), params: { assembly: { serial: @assembly.serial, title: @assembly.title } }
